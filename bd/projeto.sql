...
--
-- Host: 127.0.0.1
-- Tempo de geração: 07-Nov-2020 às 00:21
...
(291, 'Antonio Jose Da Silva', 'Rua Silva', '(54) 96658-7454', 'antonio@gmail.com', '753.159.624-54', '1965-01-01', 'Masculino', 'Casado', 'Superior', 'ConcluÃ­do', '2000-12-15', 'Escola do Centro', 'AdministraÃ§Ã£o', 'Empresa Silva', 'Gerente', '2001-01-15', '0000-00-00', 'Gerente da sua prÃ³pria empresa.', 'Yes', 'No', '5900.00', 'Assistente Comercial', '2020-10-24 - Antonio Jose Da Silva.pdf'),
(292, 'Bruna Rodrigues', 'Rua 45678', '(54) 99632-6598', 'bruna@bruna.com.br', '038.521.695-02', '1998-07-05', 'Feminino', 'Solteiro', 'Superior', 'ConcluÃ­do', '2018-09-25', 'Unopar', 'AdministraÃ§Ã£o', 'Nenhuma', 'Qualquer um', '2015-01-01', '2016-09-03', 'VÃ¡rias coisas', 'Yes', 'Yes', '1600.00', 'Web Designer Pleno', '2020-10-24 - Bruna Rodrigues.pdf');
...
--
ALTER TABLE `login_user`
  MODIFY `usuario_ide` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `pessoas`
--
ALTER TABLE `pessoas`
  MODIFY `cod_pessoa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=293;
