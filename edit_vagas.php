...
<body>
	...
	<header class="jumbotron my-4">
		<div class="container">
			...
			$sql = "UPDATE `vagas` set  `vaga` = '$vaga', `atividade` = '$atividade' WHERE id_vaga = '$id'";
			...
			if (mysqli_query($conn, $sql)) {
				...
				echo "\n";
				echo "<h3 class='display-6'>Os dados da vaga $vaga, foram alterados!</h3>";
			}
			else{
				...
				echo "\n";
				echo "<h3 class='display-6'>Os dados da vaga $vaga, não foram alterados!</h3>";
			}
			?>
